 ...
 * @generated
 */
public class UserNotificationRemoteServiceClp
	implements UserNotificationRemoteService {
	public UserNotificationRemoteServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "updateNotification";
	...
	public void updateNotification(long gorupId) {
		try {
			_invokableService.invokeMethod(_methodName3,
				_methodParameterTypes3, new Object[] { gorupId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
